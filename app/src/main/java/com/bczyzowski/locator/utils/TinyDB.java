        ...
        try {
            for (String jObjString : objStrings) {
                ...
                Location location = new Location(
                        ...
                        Float.valueOf(object.getString("accuracy")),
                        LocalDateTime.parse(object.getString("time"))
                );
    ...
    public void putListObject(String key, ArrayList<Object> objArray) {
        ...
        try {
            for (Object obj : objArray) {
                ...
                object.put("time",loc.getTime().toString());
                Log.d("TinyDb","PUT "+loc.getTime().toString());
                objStrings.add(object.toString());
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }
        Log.d("TinyDb","putList : "+objStrings.toString());
